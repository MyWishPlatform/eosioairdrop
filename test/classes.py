...
class Token:
    ...
    def __init__(self, token_id, token_admin, token_account, token_supply, token_decimals, token_symbol):
    ...
    def deploy(self):
        #self.contract = Contract(self.account.name, "eosio.token")
...
class Airdrop:
    ...
    def add_permission(self, eosio_master):
        airdrop_pubkey = self.account.json["permissions"][1]["required_auth"]["keys"][0]["key"]
